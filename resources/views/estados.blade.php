				...
				<div class="container">
					<div class="row">
						<div class="col s10 m6 l6">
							<h5 class="breadcrumbs-title mt-0 mb-0">Estados</h5>
						</div>
					</div>
				</div>
			</div>
						  ...
						  <div class="row">
							 ...
							 <div class="slide-out-right-body">
								<div class="col s12">
									...
									<form class="formValidate" id="formEstadoNuevo" method="post">
																							
											{{ csrf_field() }}		
											<div class="input-field col s12">
												<label for="txtCodigoNuevo">Código</label>
												<input id="txtCodigoNuevo" name="codigo" type="text" maxlength="2" data-error=".errorTxt1" placeholder="">
												<div class="errorTxt1"></div>
											</div>
										
											<div class="input-field col s12">
												<label for="txtDescripcionNuevo">Descripción</label>
												<input type="text" name="descripcion" id="txtDescripcionNuevo" maxlength="100" data-error=".errorTxt2" placeholder="">
						  ...
						  <div class="row">
							 ...
							 <div class="slide-out-right-second-body">
								<div class="col s12">
									...
									<form class="formValidate" id="formEstadoEditar" method="put">
