...
@section('content')
				...
				<div class="container">
					<div class="row">
						<div class="col s10 m6 l6">
							<h5 class="breadcrumbs-title mt-0 mb-0">Tipos de lentes</h5>
						</div>
					</div>
				</div>
			</div>
						  ...
						  <div class="row">
							 ...
							 <div class="slide-out-right-body">
								<div class="col s12">
									...
									<form class="formValidate" id="formLenteNuevo" method="post">
											...
											<div class="col s12">
												...
												<select class="error browser-default" id="cmbEstadoNuevo" name="estado" data-error=".errorTxt2">
						  ...
						  <div class="row">
							 ...
							 <div class="slide-out-right-second-body">
								<div class="col s12">
									...
									<form class="formValidate" id="formLenteEditar" method="post">
																							
											{{ csrf_field() }}		
											<div class="input-field col s12">
												<label for="txtCodigoEditar">Código</label>
												<input readonly id="txtCodigoEditar" name="codigo" type="text" placeholder="">
											</div>

											<div class="input-field col s12">
												<label for="txtDescripcionEditar">Descripción</label>
												<input id="txtDescripcionEditar" name="descripcion" type="text" data-error=".errorTxt5" maxlength="100" placeholder="">
												<div class="errorTxt5"></div>
											</div>
										
											<div class="col s12">
												<label for="cmbEstadoEditar">Estado</label>
												<select class="error browser-default" id="cmbEstadoEditar" name="estado" data-error=".errorTxt6">
													<option value="" disabled selected>Seleccione</option>
													<option value="A">Activo</option>
													<option value="I">Inactivo</option>
												</select>
	...
	<script src="js/tiposLentes.js" type="module"></script>
