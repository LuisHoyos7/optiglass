...
$(function() {
   ...
   if ($(".slide-out-right-second-body").length > 0) {
      var ps_slideout_right = new PerfectScrollbar(".slide-out-right-second-body", {
         suppressScrollX: true
      });
   }
...
function resizetable() {
   if($(window).width() < 976){
      ...
      if($('.vertical-layout.vertical-modern-menu .sidenav-light .brand-logo').length > 0){
         $('.vertical-layout.vertical-modern-menu .sidenav-light .brand-logo img').attr('src','app-assets/images/logo/logo-opti-glass-nuevo.png');
      }
   }
   else{
      if($('.vertical-layout.vertical-gradient-menu .sidenav-dark .brand-logo').length > 0){
         $('.vertical-layout.vertical-gradient-menu .sidenav-dark .brand-logo img').attr('src','app-assets/images/logo/logo-opti-glass-nuevo.png');
      }
      if($('.vertical-layout.vertical-dark-menu .sidenav-dark .brand-logo').length > 0){
         $('.vertical-layout.vertical-dark-menu .sidenav-dark .brand-logo img').attr('src','app-assets/images/logo/logo-opti-glass-nuevo.png');
      }
      if($('.vertical-layout.vertical-modern-menu .sidenav-light .brand-logo').length > 0){
         $('.vertical-layout.vertical-modern-menu .sidenav-light .brand-logo img').attr('src','app-assets/images/logo/logo-opti-glass-nuevo-color.png');
      }
   }
}
resizetable();
